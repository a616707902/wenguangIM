 ...
 * 本地相册
 */
public class LocalAlbum extends AppCompatActivity {
    ListView listView;
    ImageView progress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(LocalAlbum.this, LocalAlbumDetailSingle.class);
                intent.putExtra(Common.LOCAL_FOLDER_NAME, folderNames.get(i));
